...
/* 项目“DocTemplateTool.Word (net7.0)”的未合并的更改
在此之前:
using System;
...
namespace DocTemplateTool.Word.Helper
{
    public class NpoiWordParagraphTextStyleHelper
    {
        ...
        /// <returns></returns>
        public XWPFParagraph ParagraphInstanceSetting(XWPFDocument document, string fillContent, bool isBold, double fontSize, string fontFamily, ParagraphAlignment paragraphAlign, bool isStatement = false, string secondFillContent = "", string fontColor = "000000", bool isItalic = false)
        {
        ...
        /// <param name="isItalic">是否设置斜体（字体倾斜）</param>
        /// <returns></returns>  
        public XWPFParagraph SetTableParagraphInstanceSetting(XWPFDocument document, XWPFTable table, string fillContent, ParagraphAlignment paragraphAlign, int textPosition = 24, bool isBold = false, double fontSize = 10, string fontColor = "000000", bool isItalic = false, string fontFamily = "宋体")
        {
            var para = new CT_P();
            //设置单元格文本对齐
